...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-4xl font-bold text-white mb-8">Tus Canciones</h1>

    @if ($songs->isEmpty())
        <p class="text-gray-400 text-lg">No tienes canciones disponibles.</p>
    @else
            ...
            @foreach ($songs as $song)
                <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden transform transition-all hover:scale-105 hover:shadow-xl">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-500 text-sm">{{ $song->genre->name ?? 'Sin género' }}</p>
                    </div>
                </div>
            @endforeach
        </div>
...
<script>
    ...
    // Inicializar playlist con todas las canciones
    playlist = [
